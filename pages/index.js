    ...
    <>
      ...
      <SectionContainer>
        <div className="w-full pl-4 mb-8 flex">
          <img src="/static/images/mobile-header.png" alt="Fran Méndez's Mailing List" className="h-20" />
        </div>
            ...
            <div className="flex w-full">
              <div className="flex flex-col xl:mr-16">
                <h1 className="text-3xl md:text-5xl md:leading-normal xl:text-6xl xl:leading-normal font-bold text-shadow-sm shadow-purple-900 text-white mb-4 alfa-slab-one-regular">
                  Get an opinion article <span className="text-pink-400">every Sunday</span> about <span className="text-cyan-400 text-shadow-sm shadow-cyan-800">engineering</span>, <span className="text-yellow-400 text-shadow-sm shadow-yellow-800">design</span>, and <span className="text-green-400 text-shadow-sm shadow-green-800">life</span>.
                </h1>
                <p className="text-white text-lg md:text-xl xl:text-2xl">
                  I'm Fran Méndez, creator of <a href="https://asyncapi.com?utm_source=fmvilas.me&utm_medium=website&utm_campaign=homepage&utm_content=hero" target="_blank" rel="noopener noreferrer" className="font-bold text-yellow-400 hover:text-yellow-300">AsyncAPI</a>, the industry standard for describing asynchronous APIs. Put your email below and I'll make sure you always <span className="bg-yellow-500 text-black font-semibold px-2">learn something new every week</span>.
                </p>
                <a
              ...
              <a href="https://mailchi.mp/26bd1e12ea67/fran-mndezs-mailing-list-radical-transparency">
                <article className="shadow-lg bg-cyan-600 bg-gradient-custom bg-blend-overlay rounded-2xl flex-1">
                  <div className="relative aspect-video sm:aspect-[4/2] lg:w-full lg:shrink-0">
                    ...
                    />
                    <time dateTime="2022-02-04" className="text-white/50 font-bold absolute bottom-4 left-6">
                      February 4, 2022
                    </time>
                  </div>
                </article>
