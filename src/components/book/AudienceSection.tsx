...
const AudienceSection = () => {
  return (
    <section id="audience" className="py-16 md:py-24 bg-book-navy text-white">
      <div className="container px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 opacity-0 animate-slide-up animate-delay-300">
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-colors">
            <h3 className="text-xl font-bold text-book-teal mb-3">Staff+ Software Engineers</h3>
            <ul className="space-y-3">
              {[
                ...
                <li key={index} className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-book-amber flex-shrink-0 mt-0.5" />
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-colors">
            <h3 className="text-xl font-bold text-book-teal mb-3">Software Architects</h3>
            <ul className="space-y-3">
              {[
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-colors md:col-span-2 lg:col-span-1">
            <h3 className="text-xl font-bold text-book-teal mb-3">Engineering Leaders</h3>
            <ul className="space-y-3">
              {[
